...
```
correctionField = 0x0000000000028000
值 = 0x28000 / 65536 = 2.5纳秒
```
...
00 00 00 00 00 00 03 E8  // originTimestamp秒=1000
...
```
00 0B 00 3E    // messageType=0xB(Announce), length=62
...
下一节，我们将讲解**TLV扩展机制**——如何在固定格式基础上，灵活扩展PTP功能。
